        ...
        <div className="mx-auto max-w-screen-2xl px-4 md:px-8 flex flex-row">
          <div className="mb-6 flex items-end justify-start gap-4">
            ...
            <div className="flex flex-row">
              <div>
                <Link href="https://homelesstailor.tumblr.com/post/186747414468/19aw" className="group relative mb-2 block h-80 overflow-hidden rounded-lg bg-gray-100 lg:mb-3">
