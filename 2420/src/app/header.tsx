  ...
  return (
    <header className="z-50 w-full bg-white text-sm py-5 dark:bg-gray-800">
        ...
        <div className="flex flex-row items-end gap-5 mt-5 justify-end px-5 sm:mt-0 sm:pl-5">
            <a className="justify-end font-medium text-gray-600 hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-500" href="#">Brand一覧</a>
            ...
            <a className="justify-end font-medium text-gray-600 hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-500" href="#">ブランドはこちら</a>
            <a className="justify-end font-medium text-gray-600 hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-500" href="#">マイページ</a>
